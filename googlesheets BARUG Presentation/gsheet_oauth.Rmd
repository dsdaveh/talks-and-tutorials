...
drive_share(new_sheet, user = 'o9e4g9@u.northwestern.edu', role='reader')
drive_share(new_sheet)
gs_delete(new_sheet)
```

hmmm... it worked last month when I tried it...
...
![performance](snap_upload_times.png)
...
With a little more work though, you can preserve edits and augmentations by linking the data from the sheet that googlesheets updates, and making changes to that linked sheet.  The key to this is the `IMPORTRANGE` function in Sheets, I've got a detailed write up on that here: [Automated Google Sheets updates for Charts and Pivot Tables](http://rpubs.com/dsdaveh/280034)
